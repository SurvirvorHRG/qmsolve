...
cont_sodium = rd_sodium.final_plot2(axs[1], L_norm = 1e-6,Z_norm = 1e-6,unit = 1e-3,fixmaximum = 0.1)
...
cont_rubidium = rd_rubidium.final_plot2(axs[2],L_norm = 1e-6,Z_norm = 1e-6,unit = 1e-3,fixmaximum = 0.1)
