...
# Potentiel
l=1             # Radial index
w0=0.0300185    # Laser waist (mm) !1.0378725 pour l=1 0.0300185 pour l=6
w1=0.0300185    # Laser waist (mm) !1.0378725 pour l=1 0.0300185 pour l=6
...
visualization.plot(t = 0 ,unit = femtoseconds,contrast_vals=[0.9,1])
