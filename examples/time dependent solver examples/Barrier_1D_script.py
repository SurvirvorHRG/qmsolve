...
visualization.final_plot2(axs[0],L_norm = 1e-6,Z_norm =  1e-6,unit = 1e-3)
axs[0].set_title('$U_{z} = 0.25$',fontsize = font)
...
visualization = init_visualization(sim)
visualization.final_plot2(axs[1],L_norm =  1e-6,Z_norm =  1e-6,unit = 1e-3)
axs[1].set_title('$U_{z} = 0.5$',fontsize = font)
...
visualization = init_visualization(sim)
cont = visualization.final_plot2(axs[2],L_norm =  1e-6,Z_norm =  1e-6,unit = 1e-3)
axs[2].set_title('$U_{z} = 0.75$',fontsize = font)
...
"""
visualization = init_visualization(sim)
cont = visualization.final_plot2(axs[3],L_norm =  1e-6,Z_norm =  1e-6,unit = 1e-3)
axs[3].set_title('$U_{z} = 1$',fontsize = font)
"""

# Adjust layout
plt.tight_layout()

cbar = fig.colorbar(cont, ax=axs, orientation='vertical', fraction=0.04, pad=0.01)
