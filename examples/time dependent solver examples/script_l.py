...
# Lithium
"""
rd_lithium = readFile('l=1_bb.txt')
cont_lithium = rd_lithium.final_plot2(axs[0],L_norm = 1e-6,Z_norm =  1e-6,unit =  1e-3)
axs[0].set_title('$(a)\ \ell = 1$', fontsize=font)
"""
# Sodium


rd_sodium = readFile('l=3_bb.txt')
cont_sodium = rd_sodium.final_plot2(axs[0],L_norm = 1e-6,Z_norm =  1e-6,unit =  1e-3)
axs[0].set_title('$(a)\ \ell = 3$', fontsize=font)

# Rubidium


rd_rubidium = readFile('l=6_bb.txt')
cont_rubidium = rd_rubidium.final_plot2(axs[1],L_norm = 1e-6,Z_norm =  1e-6,unit =  1e-3)
