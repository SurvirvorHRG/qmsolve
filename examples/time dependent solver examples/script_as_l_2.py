...
rd_sodium = readFile('22.txt')
cont_sodium = rd_sodium.final_plot2(axs[0], L_norm = 1e-6,Z_norm = 1e-6,unit = 1e-3,fixmaximum = 0.1)
axs[0].set_title('$(b)\ \ell = 3$', fontsize=font)
axs[0].set_xlim(-1000, 1000)
# Rubidium


rd_rubidium = readFile('333.txt')
cont_rubidium = rd_rubidium.final_plot2(axs[1],L_norm = 1e-6,Z_norm = 1e-6,unit = 1e-3,fixmaximum = 0.1)
axs[1].set_title('$(c)\ \ell = 6$', fontsize=font)
